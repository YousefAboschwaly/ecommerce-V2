...
// Step Images
const stepImages = [
  "https://images.unsplash.com/photo-1596526131083-e8c633c948d2?w=800&q=80", // Email input image
  "https://images.unsplash.com/photo-1614064641938-3bbee52942c7?w=800&q=80", // Verification code image
  "https://images.unsplash.com/photo-1555421689-491a97ff2040?w=800&q=80", // New password image
];
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-8">
      <div className="relative flex justify-between">
        ...
        {/* Progress line */}
        <div 
          className="absolute top-4 left-0 h-[2px] bg-blue-500 transition-all duration-500"
          style={{ 
            ...
            <div key={step} className="relative flex flex-col items-center">
              <div
                className={cn(
                  ...
                  {
                    'border-blue-500 bg-blue-500 text-white': status === 'completed',
                    'border-blue-500 text-blue-500 bg-white': status === 'current',
                    'border-gray-300 text-gray-300 bg-white': status === 'upcoming'
                  }
                )}
              >
                {status === 'completed' ? (
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (response.data.token) {
          ...
          setTimeout(() => {navigate("/login");setIsLoading(false);}, 4000);
        }
      } catch (err: any) {
